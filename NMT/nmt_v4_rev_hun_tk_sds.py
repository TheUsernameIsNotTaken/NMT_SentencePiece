...
if (DO_TRAINING):
    ...
    spm.SentencePieceTrainer.train(f'--input=hun-eng/input_sentences.txt --model_prefix=m_hu_sds --vocab_size={MAX_NUM_TOKENS}')
    print("Training HUN SentencePiece Model...")
    spm.SentencePieceTrainer.train(f'--input=hun-eng/output_sentences.txt --model_prefix=m_en_sds --vocab_size={MAX_NUM_TOKENS}')
...
sp_hu.load('m_hu_sds.model')
sp_en = spm.SentencePieceProcessor()
sp_en.load('m_en_sds.model')
...
word2idx_inputs = {}
with open('m_hu_sds.vocab', mode='r', encoding='utf-8') as in_file:
    i = 0
    for line in in_file:
...
word2idx_outputs = {}
with open('m_en_sds.vocab', mode='r', encoding='utf-8') as in_file:
    i = 0
    for line in in_file:
        key = line.rstrip().split('\t')[0]
...
if(DO_TRAINING):
    ...
    model.save('seq2seq_eng-hun_spt_rev_sds.keras')
...
model.load_weights('seq2seq_eng-hun_spt_rev_sds.keras')
