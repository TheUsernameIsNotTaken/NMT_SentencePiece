...
print("Hungarian translation: ", output_sentences[180])
...
print(word2idx_outputs["hívjon"])
print(word2idx_outputs["fel"])
print(word2idx_outputs["minket!"])
...
if(DO_TRAINING):
    ...
    model.save('seq2seq_eng-hun.keras')
...
model.load_weights('seq2seq_eng-hun.keras')
