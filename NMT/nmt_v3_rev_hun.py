...
print("English translation: ", output_sentences[180])
...
length_df = pd.DataFrame({'hungarian':hu_len, 'english':en_len})
...
You may recall that the original sentence at index 180 is **call us**. The tokenizer divided the sentence into two words ***call*** and ***us***, converted them to integers, and then applied pre-padding by adding four zeros at the start of the corresponding integer sequence for the sentence at index 180 of the input list.

To verify that the integer values for ***call*** and ***us*** are 141 and 69 respectively, you can pass the words to the word2index_inputs dictionary, as shown below:


print(word2idx_inputs["hívjon"])
print(word2idx_inputs["fel"])
print(word2idx_inputs["minket!"])
"""
...
"""The sentence at index 180 of the decoder input is <sos> Hívjon fel minket. If you print the corresponding integers from the word2idx_outputs dictionary, you should see 2, 2028, 20, and 228 printed on the console.

print(word2idx_outputs["call"])
print(word2idx_outputs["us"])
"""
...
if(DO_TRAINING):
    ...
    model.save('seq2seq_eng-hun_rev.keras')
...
model.load_weights('seq2seq_eng-hun_rev.keras')
